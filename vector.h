...
// Typedef a vector
#define TYPEDEF_VEC(Name, type) _TYPEDEF_VEC(Name, type, type)
#define _TYPEDEF_VEC(Name, type, up_type)                                                               \
    /* Vector */                                                                                        \
    typedef struct                                                                                      \
    {                                                                                                   \
        size_t size;                                                                                    \
    ...
    static inline type *Vec##Name##Begin(Vec##Name##_t vec) { return &vec->data[0]; };                  \
    static inline const type *Vec##Name##CBegin(Vec##Name##_t vec) { return &vec->data[0]; };           \
    /* Returns an iterator to the end */                                                                \
    static inline type *Vec##Name##End(Vec##Name##_t vec) { return &vec->data[vec->size - 1]; };        \
    static inline const type *Vec##Name##CEnd(Vec##Name##_t vec) { return &vec->data[vec->size - 1]; }; \
    /* Returns a reverse iterator to the beginning */                                                   \
    static inline type *Vec##Name##RBegin(Vec##Name##_t vec);                                           \
    static inline const type *Vec##Name##CRBegin(Vec##Name##_t vec);                                    \
    /* Returns a reverse iterator to the end */                                                         \
    static inline type *Vec##Name##REnd(Vec##Name##_t vec);                                             \
    static inline const type *Vec##Name##CREnd(Vec##Name##_t vec);                                      \
                                                                                                        \
    /********** CAPACITY **********/                                                                    \
                                                                                                        \
